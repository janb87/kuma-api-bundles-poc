 ...
 * ButtonPagePart
 *
 * @ORM\Table(name="kuma_bundle_apipocbundle_button_page_parts")
 * @ORM\Entity
 */
class ButtonPagePart extends AbstractPagePart
{
    ...
    {
        return 'KumaApiPocBundle:PageParts:ButtonPagePart/view.html.twig';
    }
    ...
    {
        return \Kuma\Bundle\ApiPocBundle\Form\PageParts\ButtonPagePartAdminType::class;
    }
}
