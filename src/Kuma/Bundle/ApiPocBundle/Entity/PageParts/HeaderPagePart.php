 ...
 * HeaderPagePart
 *
 * @ORM\Table(name="kuma_bundle_apipocbundle_header_page_parts")
 * @ORM\Entity
 */
class HeaderPagePart extends AbstractPagePart
{
    ...
    {
        return 'KumaApiPocBundle:PageParts:HeaderPagePart/view.html.twig';
    }
    ...
    {
        return \Kuma\Bundle\ApiPocBundle\Form\PageParts\HeaderPagePartAdminType::class;
    }
}
