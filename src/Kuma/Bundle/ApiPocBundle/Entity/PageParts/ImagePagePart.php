 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="kuma_bundle_apipocbundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
        return 'KumaApiPocBundle:PageParts:ImagePagePart/view.html.twig';
    }
    ...
    {
        return \Kuma\Bundle\ApiPocBundle\Form\PageParts\ImagePagePartAdminType::class;
    }
}
