 ...
 * LinkPagePart
 *
 * @ORM\Table(name="kuma_bundle_apipocbundle_link_page_parts")
 * @ORM\Entity
 */
class LinkPagePart extends AbstractPagePart
{
    ...
    {
        return 'KumaApiPocBundle:PageParts:LinkPagePart/view.html.twig';
    }
    ...
    {
        return \Kuma\Bundle\ApiPocBundle\Form\PageParts\LinkPagePartAdminType::class;
    }
}
