...
/**
 * @ORM\Entity
 * @ORM\Table(name="kuma_bundle_apipocbundle_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
        return "KumaApiPocBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
        return \Kuma\Bundle\ApiPocBundle\Form\PageParts\VideoPagePartAdminType::class;
    }
}
