...
namespace Kuma\Bundle\ApiPocBundle\Form\PageParts;
...
use Kuma\Bundle\ApiPocBundle\Entity\PageParts\HeaderPagePart;
...
class HeaderPagePartAdminType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => '\Kuma\Bundle\ApiPocBundle\Entity\PageParts\HeaderPagePart'
        ));
    }
}
